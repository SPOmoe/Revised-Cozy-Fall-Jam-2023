class MainScene extends Phaser.Scene {
    ...
    create() {
        ...
        const biomeMiscLayer = map.createLayer("Misc. Pretties", grassBiomeTiles, 0, 0).setDepth(100);
        ...
        biomeMiscLayer.setCollisionByProperty({collides: true});
        ...
        this.physics.add.collider(this.slime, biomeMiscLayer);
